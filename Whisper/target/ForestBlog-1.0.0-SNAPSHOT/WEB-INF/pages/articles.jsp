...
<%--                </a></nav>--%>
    ...
    <header class="c-appHeader">
        ...
        <a href="/article/create?userId=${userId}" class="c-appHeader__link">
            新建提问箱
        </a><a href="/article/all?userId=${userId}" class="c-appHeader__link">
        全部提问箱
    </a>
